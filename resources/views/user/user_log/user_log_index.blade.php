        ...
        <div class="card-body">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <a href="{{ route('user_log.user_log_index') }}" class="btn btn-success float-xl-right float-lg-right">Generate PDF</a>
                    </div>
                </div>
            ...
            <div class="row my-4">
                ...
                <div class="col-xl-8 col-lg-8 pr-xl-5 pr-lg-5">
                    <div class="row my-3">
                        ...
                        <div class="col-xl-6">
                            <form action="{{ route('user_log.clock_in') }}" method="post">
                                @csrf
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-xl-6">
                            <form action="{{ route('user_log.clock_out') }}" method="post">
                                @csrf
