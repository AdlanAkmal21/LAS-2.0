...
<section class="bg-info">
    <div class="d-flex align-items-end flex-column">
        <ol class="breadcrumb bg-transparent">
            <li class="breadcrumb-item"><a href="{{ route('admin.index') }}" class="text-light">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.employee_list') }}" class="text-light">Employee List</a></li>
            <li class="breadcrumb-item active text-muted">Employee Detail</li>
        </ol>
    </div>
    ...
    <div class="card my-3">
        ...
        <div class="card-body text-sm-right">
            <form>
                ...
                <div class="form-group row">
                    <label class="col-sm-6 col-form-label" for="replacement_leaves">Replacement Leaves</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label class="col-sm-6 col-form-label" for="special_leaves">Special Leaves</label>
                    <div class="col-sm-6">
