...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Manage Office</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Office Logs</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.admin_office_search') }}" method="post">
            @csrf
            <div class="form-row form-group">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="form-row">
                        ...
                        <div class="col">
                            <form action="{{ route('print.generate_office_log_admin') }}" method="post">
                                @csrf
